...
const Features = () => {
    ...
    const leftColumnAnimation = useSpring({
        ...
        transform: isVisible.leftColumn
            ? "translateX(0%)"
            : "translateX(-100%)",
    ...
    const rightColumnAnimation = useSpring({
        ...
        transform: isVisible.rightColumn
            ? "translateX(0%)"
            : "translateX(100%)",
        config: { tension: 200, friction: 30 },
    });
    ...
    const carContainerAnimation = useSpring({
        ...
        transform: isVisible.carContainer
            ? "translateY(0%)"
            : "translateY(-100%)",
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            if (rightColumnRef.current)
                observer.unobserve(rightColumnRef.current);
    ...
    <div className={styles.featuresContainer1}>
        ...
        <div className={styles.featuresContainername}>
            <h1>Our Features</h1>
            <p>
            ...
            <div className={styles.features}>
                ...
                <div className={styles.column} ref={carContainerRef}>
                    <animated.div
                        style={carContainerAnimation}
                        className={styles.carContainer}
                    >
                                            </animated.div>

                        <animated.div
                        style={rightColumnAnimation}>
                        <div className={styles.carBackground}>                                             </div>
                        <img
